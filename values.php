...
$mainValues = [
    ...
    'user_not_found'=>"آی دی عددی کاربر اشتباه است",
...
",
  ...
  بعد از اینکه پرداخت شما تایید شد ( لینک سابسکریپشن ) به صورت خودکار از طریق همین ربات  برای شما ارسال میشه ، جهت خرید بدون معطلی از دقعات بعد حساب خود را قبل از خرید شارژ کنید",
...
•TYPE افزایش: INCREASE گیگ/ از
 قیمت: PRICE تومان",
    ...
    'join_channel_message'=>" ❌ برای استفاده از ربات باید حتما در کانال شخصی VIPVPN Sellers عضو شده باشید:
...
آیدی عددی: USERID
 ",
    "not_joine_yet"=>"متاسفانه دکمه عضویت در کانال کار نمی کند",
...
از این بخش میتوانید اطلاعات پنل همکاری خود را مشاهده کنید",
